...
class Cloud extends AbstractGameObject {
    ...
    public void render(SpriteBatch batch) {
        batch.draw(regCloud.getTexture(), position.x + origin.x,
                position.y + origin.y, origin.x, origin.y, dimension.x,
                dimension.y, scale.x, scale.y, rotation, regCloud.getRegionX(),
                regCloud.getRegionY(), regCloud.getRegionWidth(), regCloud.getRegionHeight(),
                false, false);
    }
}
