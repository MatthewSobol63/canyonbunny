...
public class BunnyHead extends AbstractGameObject {
    ...
    public void init () {
        dimension.set(1, 1);
        texture = Assets.instance.bunny.head;
    ...
    public void render(SpriteBatch batch) {
        ...
        // Draw image
        batch.draw(texture.getTexture(), position.x, position.y, origin.x,
                origin.y, dimension.x, dimension.y, scale.x, scale.y, rotation,
                texture.getRegionX(), texture.getRegionY(), texture.getRegionWidth(),
                texture.getRegionHeight(), viewDirection == VIEW_DIRECTION.LEFT, false);
